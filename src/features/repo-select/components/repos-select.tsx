...
export function ReposSelect({ token, repo }: { token: string; repo: string }) {
  ...
  return (
    <div className="p-4 flex flex-col md:flex-row justify-center gap-2 h-24 md:gap-4 md:h-20 border border-white/20 items-center bg-black/30 backdrop-blur-2xl rounded-lg">
