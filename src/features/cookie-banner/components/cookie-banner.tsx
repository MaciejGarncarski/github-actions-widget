...
export const CookieBanner = ({ accepted }: { accepted: boolean }) => {
  ...
  return (
    <div className="border-black/30 border fixed z-20 bottom-4 left-4 right-4 md:left-8 max-w-lg md:right-8 bg-black/20 backdrop-blur-xl rounded-lg p-4 flex flex-col md:flex-row items-center justify-between animate-slide-up">
